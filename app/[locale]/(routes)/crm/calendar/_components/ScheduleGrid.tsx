...
function DayGrid({ data, isPending, onAppointmentClick }: { data: CalendarData; isPending: boolean; onAppointmentClick?: (appt: CalendarAppointment) => void }) {
...
function WeekGrid({ data, selectedDate, isPending, onAppointmentClick }: { data: CalendarData; selectedDate: Date; isPending: boolean; onAppointmentClick?: (appt: CalendarAppointment) => void }) {
...
export function ScheduleGrid({ data, selectedDate, viewMode, isPending, onAppointmentClick }: ScheduleGridProps) {
  if (viewMode === "day") return <DayGrid data={data} isPending={isPending} onAppointmentClick={onAppointmentClick} />;
  return <WeekGrid data={data} selectedDate={selectedDate} isPending={isPending} onAppointmentClick={onAppointmentClick} />;
}
